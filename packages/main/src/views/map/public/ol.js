...
(function (root, factory) {
  ...
  function ha(a) {
    this.message =
      "Assertion failed. See https://openlayers.org/en/v4.5.0/doc/errors/#" +
      a +
      " for details.";
    this.code = a;
...
*/
  ...
  var zb = 6378137 * Math.PI,
    ...
    Ab = [
      ...
      new wb("EPSG:102113"),
      new wb("EPSG:900913"),
      new wb("urn:ogc:def:crs:EPSG:6.18:3:3857"),
      new wb("urn:ogc:def:crs:EPSG::3857"),
      new wb("http://www.opengis.net/gml/srs/epsg.xml#3857"),
    ];
  function Bb(a, b, c) {
    var d = a.length;
    c = 1 < c ? c : 2;
  ...
  var Eb = [-180, -90, 180, 90],
    ...
    Gb = [
      new Db("CRS:84"),
      new Db("EPSG:4326", "neu"),
      new Db("urn:ogc:def:crs:EPSG::4326", "neu"),
      new Db("urn:ogc:def:crs:EPSG:6.6:4326", "neu"),
      new Db("urn:ogc:def:crs:OGC:1.3:CRS84"),
      new Db("urn:ogc:def:crs:OGC:2:84"),
      new Db("http://www.opengis.net/gml/srs/epsg.xml#4326", "neu"),
      new Db("urn:x-ogc:def:crs:EPSG:4326", "neu"),
    ];
  var Hb = {};
  var Ib = {};
  function Jb(a, b, c) {
  ...
  function Mb(a, b, c, d) {
    ...
    e
      ...
      : ("degrees" == a.a && !d) ||
        ...
        (b = e(b, b, 2)),
        (b =
          (Lb.b(b.slice(0, 2), b.slice(2, 4)) +
            Lb.b(b.slice(4, 6), b.slice(6, 8))) /
          2),
        (a = d ? tb[d] : a.Wc()),
        void 0 !== a && (b /= a));
    return b;
    ...
    if (!e) {
      ...
      if ("function" == typeof f) {
        ...
        void 0 !== g &&
          ...
          (g === h
            ? Pb([b, a])
            : ((e = f(d, c)), Ub(b, a, e.forward, e.inverse)),
          (e = Kb(c, d)));
      }
    }
    e || (e = Yb);
  ...
  function qc(a) {
    ...
    this.c = null;
    void 0 !== a.origins &&
      ((this.c = a.origins), na(this.c.length == this.b.length, 20));
    d = a.extent;
    void 0 === d || this.g || this.c || (this.g = Ya(d));
    na((!this.g && this.c) || (this.g && !this.c), 18);
    this.i = null;
    void 0 !== a.tileSizes &&
      ((this.i = a.tileSizes), na(this.i.length == this.b.length, 19));
  ...
  function Ac(a, b, c) {
    a = Dc(a);
    b = Cc(a, b, c);
    return new qc({ extent: a, origin: Ya(a), resolutions: b, tileSize: c });
  }
  function Dc(a) {
    a = Nb(a);
    var b = a.C();
  ...
  function y(a, b, c, d, e) {
    ...
    (f = Hc(g, c, d, !1))
      ? e || (f.Ch = !1)
      : ((f = { Ah: d, Ch: !!e, listener: c, target: a, type: b }),
  ...
  k.set = function (a, b, c) {
    c
      ? (this.P[a] = b)
      : ((c = this.P[a]), (this.P[a] = b), c !== b && Yc(this, a, c));
  };
  k.I = function (a, b) {
  ...
  k.wp = function (a, b) {
    this.a[b.pointerId] = { target: b.target, out: b, mj: b.target };
    var c = this.b;
    b.bubbles = !0;
  ...
  k.Fm = function (a, b) {
    ...
    if (c) {
      ...
      d &&
        ...
        (d.target = e),
        b.target
          ? (Id(this.b, d, a), Hd(this.b, b, a))
          : ((b.target = e), (b.relatedTarget = null), this.Mf(a, b)));
      c.out = b;
      c.mj = b.target;
    }
  };
  ...
  k.Gq = function (a, b) {
    ...
    b.isPrimary &&
      ((this.g = void 0), (this.c = setTimeout(this.zj.bind(this), 200)));
  };
  k.Cq = function (a) {
    Ud(this, a, this.Mf);
  };
  ...
  k.gm = function (a) {
    ...
    0 === this.i.length &&
      ...
      this.i.push(
        y(this.a, "pointermove", this.cn, this),
        y(this.a, "pointerup", this.$h, this),
        y(this.f, "pointercancel", this.$h, this)
      ));
  };
  k.cn = function (a) {
    if (fe(this, a)) {
          ...
          for (; b < q; ) {
            ...
            if (ya != V || fa != g) {
              var pa = V - z,
                ...
                Sa = fa - E;
              (pa * Sa == Ja * ma &&
                ((0 > pa && ma < pa) || pa == ma || (0 < pa && ma > pa)) &&
                ((0 > Ja && Sa < Ja) || Ja == Sa || (0 < Ja && Sa > Ja))) ||
                ((x[C++] = V), (x[C++] = g), (z = V), (E = g));
              V = ya;
              g = fa;
            }
  ...
  k.Nb = function (a, b, c, d) {
    ...
    this.c != this.g &&
      ((this.j = Math.sqrt(qf(this.A, 0, this.A.length, this.a, 0))),
      (this.c = this.g));
  ...
  k.na = function (a, b) {
    a
      ? (kf(this, b, a, 1),
        this.A || (this.A = []),
        (this.A.length = xf(this.A, 0, a, this.a)),
        this.u())
      : Ff(this, "XY", null);
  };
  function Ff(a, b, c) {
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ga(this.C(), a, b)) return d;
    this.B != this.g &&
      ((this.H = Math.sqrt(tf(this.A, 0, this.c, this.a, 0))),
      (this.B = this.g));
  ...
  k.Xb = function () {
    if (this.G != this.g) {
      ...
      Of(a, this.c, this.a)
        ? (this.j = a)
        : ((this.j = a.slice()),
          (this.j.length = Pf(this.j, 0, this.c, this.a)));
      this.G = this.g;
    }
    return this.j;
  };
  ...
  function Yf(a, b) {
    ...
    if (void 0 !== b.resolutions) {
      ...
      h = g.C();
      var l =
          (h ? Math.max(ab(h), bb(h)) : (360 * tb.degrees) / g.Wc()) /
          256 /
          Math.pow(2, 0),
        m = l / Math.pow(2, 28);
      g = b.maxResolution;
  ...
  k.animate = function (a) {
    ...
    if ($f(this)) {
      for (
        ...
        void 0 !== m.zoom
          ? ((n.je = f),
            (n.jd = this.constrainResolution(this.a, m.zoom - this.s, 0)),
            (f = n.jd))
          : m.resolution && ((n.je = f), (n.jd = m.resolution), (f = n.jd));
        void 0 !== m.rotation &&
          ((n.Bf = g),
          (n.me = g + (va(m.rotation - g + Math.PI, 2 * Math.PI) - Math.PI)),
          (g = n.me));
        n.callback = c;
        (n.he && n.le && !Ee(n.he, n.le)) || n.je !== n.jd || n.Bf !== n.me
          ? (d += n.duration)
          : (n.complete = !0);
        h.push(n);
      }
      ...
      (b = arguments[b - 1]),
        b.center && this.tb(b.center),
        void 0 !== b.zoom && this.Oj(b.zoom),
        void 0 !== b.rotation && this.ae(b.rotation),
        c && c(!0);
  };
  k.zc = function () {
    return 0 < this.i[0];
      ...
      for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
        for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
          ...
          if (!h.complete) {
            ...
            h.je &&
              h.jd &&
              ((l = 1 === b ? h.jd : h.je + b * (h.jd - h.je)),
              h.anchor && this.set("center", bg(this, l, h.anchor)),
              this.set("resolution", l));
            void 0 !== h.Bf &&
              void 0 !== h.me &&
              ((b =
                1 === b
                  ? va(h.me + Math.PI, 2 * Math.PI) - Math.PI
                  : h.Bf + b * (h.me - h.Bf)),
              h.anchor && this.set("center", cg(this, b, h.anchor)),
              this.set("rotation", b));
            b = !0;
            if (!h.complete) break;
          }
        ...
        e &&
          ((this.c[c] = null), ag(this, 0, -1), (d = d[0].callback) && d(!0));
      }
  ...
  k.Sf = function (a, b) {
    ...
    void 0 !== b.duration
      ...
      : (this.fd(c), this.tb(a), setTimeout(e.bind(void 0, !0), 0));
  };
  k.Ik = function (a, b, c) {
    var d = this.Ra(),
      e = Math.cos(-d);
  ...
  function lg(a) {
    ...
    b
      ? Array.isArray(b)
        ? (b = new A(b.slice(), { unique: !0 }))
        : na(b instanceof A, 43)
      : (b = new A(void 0, { unique: !0 }));
    this.Ni(b);
  }
  v(lg, jg);
  k = lg.prototype;
  ...
  k.$l = function () {
    ...
    for (c = a.length; b < c; b++) {
      var d = a[b];
      this.c[w(d).toString()] = [
        y(d, "propertychange", this.Oe, this),
        y(d, "change", this.Oe, this),
      ];
    }
    this.u();
  };
  k.Zl = function (a) {
    ...
    var b = w(a).toString();
    this.c[b] = [
      y(a, "propertychange", this.Oe, this),
      y(a, "change", this.Oe, this),
    ];
    this.u();
  };
  k.am = function (a) {
  ...
  k.bg = function (a) {
    ...
    for (d = b.length; c < d; c++) {
      ...
      void 0 !== a.extent &&
        (e.extent = void 0 !== e.extent ? eb(e.extent, a.extent) : a.extent);
    }
    return b;
  };
  k.fg = function () {
    ...
    if (this.c)
      return (
        ...
        this.oc.Ga(
          ...
          b,
          null,
          void 0 !== c.layerFilter ? c.layerFilter : Qe,
          null
        )
      );
  };
  ...
  k.lg = function (a, b) {
    ...
    return this.oc.Ri(
      ...
      void 0 !== b.layerFilter ? b.layerFilter : Qe,
      null
    );
  };
  k.Rd = function (a) {
  ...
  k.pm = function () {
    ...
    a
      ? (a.appendChild(this.a),
        (a = this.aa ? this.aa : a),
        (this.s = [
          y(a, "keydown", this.wd, this),
          y(a, "keypress", this.wd, this),
        ]),
        this.i ||
          ((this.i = this.Mc.bind(this)),
  ...
  k.rm = function () {
    ...
    a &&
      ...
      (this.H = y(a, "propertychange", this.bi, this)),
  ...
  k.hq = function (a) {
    ...
    g &&
      ...
      Array.prototype.push.apply(this.va, g.postRenderFunctions),
      !f ||
        (this.f && ($a(this.f) || Ra(g.extent, this.f))) ||
        (this.b(new dd("movestart", this, f)), (this.f = Na(this.f))),
      !this.f ||
        g.viewHints[0] ||
        g.viewHints[1] ||
        Ra(g.extent, this.f) ||
        (this.b(new dd("moveend", this, g)), Fa(g.extent, this.f)));
  ...
  function rg(a) {
    ...
    if (void 0 === a.logo || ("boolean" === typeof a.logo && a.logo))
      ...
      "string" === typeof e
        ...
        ? (d[w(e).toString()] = e)
        : e &&
          (na("string" == typeof e.href, 44),
          na("string" == typeof e.src, 45),
          (d[e.src] = e.href));
    }
    ...
    void 0 !== a.overlays
      ? Array.isArray(a.overlays)
        ...
        : (na(a.overlays instanceof A, 49), (a = a.overlays))
      : (a = new A());
    return {
      controls: q,
      interactions: r,
  ...
  tg.prototype.setMap = function (a) {
    ...
    this.s.length = 0;
    if ((this.a = a))
      (this.G ? this.G : a.v).appendChild(this.element),
        this.render !== da &&
  ...
  function yg(a) {
    if ((a = a.frameState)) {
      ...
      if (!gc(c, this.H)) {
        ...
        this.B != b &&
          ((this.element.style.display = b ? "" : "none"), (this.B = b));
        this.H = c;
        a = a.logos;
        c = this.O;
  ...
  Ag.prototype.D = function (a) {
    ...
    void 0 !== this.l
      ...
      : (a = this.a.$()) &&
        void 0 !== a.Ra() &&
        (0 < this.v
          ? a.animate({ rotation: 0, duration: this.v, easing: Ne })
          : a.ae(0));
  };
  function Bg(a) {
    if ((a = a.frameState)) {
  ...
  Cg.prototype.j = function (a, b) {
    ...
    if ((b = this.a.$())) {
      ...
      c &&
        ...
        0 < this.c
          ? (b.zc() && b.pd(),
            b.animate({ resolution: a, duration: this.c, easing: Ne }))
          : b.fd(a));
    }
  };
  function Dg(a) {
    ...
    (void 0 !== a.attribution ? a.attribution : 1) &&
      b.push(new xg(a.attributionOptions));
    return b;
  }
  function Eg(a, b, c) {
    this.i = a;
  ...
  function Ig(a, b, c, d) {
    if (void 0 !== b) {
      var e = a.Ra(),
        f = a.wa();
      void 0 !== e && f && 0 < d
        ? a.animate({ rotation: b, anchor: c, duration: d, easing: Ne })
        : a.rotate(b, c);
    }
  }
  function Qg(a, b, c, d) {
  ...
  function Rg(a, b, c, d) {
    if (b) {
      var e = a.Qa(),
        f = a.wa();
      void 0 !== e && f && b !== e && d
        ? a.animate({ resolution: b, anchor: c, duration: d, easing: Ne })
  ...
  function eh(a) {
    ...
    if ("pointerdown" === c || "pointerdrag" === c || "pointerup" === c) {
      ...
      "pointerup" == a.type
        ...
        : "pointerdown" == a.type
        ? (this.aa[d] = c)
        : d in this.aa && (this.aa[d] = c);
      this.l = lb(this.aa);
    }
    this.D
      ? "pointerdrag" == a.type
        ? this.zk(a)
        : "pointerup" == a.type && (this.D = this.Gk(a) && 0 < this.l.length)
      : "pointerdown" == a.type
      ? ((this.D = a = this.Yj(a)), (b = this.hd(a)))
      : "pointermove" == a.type && this.Fk(a);
    return !b;
  }
  ...
  function lh(a) {
    return bh(a) && Wg(a) && this.f(a)
      ? (ag(a.map.$(), 1, 1), (this.a = void 0), !0)
      : !1;
  }
  kh.prototype.hd = Re;
  function oh(a) {
  ...
  function uh(a) {
    ...
    this.s(a, this.f, a.pixel) &&
      (this.j(a), this.b(new wh(yh, a.coordinate, a)));
    return !1;
  }
  function sh(a) {
  ...
  function Ch(a) {
    ...
    if ("keydown" == a.type) {
      ...
      if (this.f(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
        ...
        c = this.j;
        if ((e = b.wa()))
          (d = b.Qc([e[0] + d[0], e[1] + d[1]])),
            c ? b.animate({ duration: c, easing: Pe, center: d }) : b.tb(d);
        a.preventDefault();
        b = !0;
      }
    }
  ...
  function Ph(a) {
    ...
    this.a = !1;
    this.s = 0;
    this.B = void 0 !== a.threshold ? a.threshold : 0.3;
  ...
  function Rh(a) {
    ...
    void 0 !== this.j &&
      ((b = c - this.j),
      (this.s += b),
      !this.a && Math.abs(this.s) > this.B && (this.a = !0));
    this.j = c;
    a = a.map;
    c = a.$();
    if (c.j.rotation !== re) {
  ...
  function Xh(a) {
    ...
    if (void 0 !== a.keyboard ? a.keyboard : 1)
      b.push(new Bh()),
        b.push(new Dh({ delta: a.zoomDelta, duration: a.zoomDuration }));
    ...
    (void 0 !== a.shiftDragZoom ? a.shiftDragZoom : 1) &&
      b.push(new Ah({ duration: a.zoomDuration }));
    return b;
  }
  ...
  k.get = function (a) {
    ...
    a === this.g
      ? ((this.g = this.g.hb), (this.g.Pb = null))
      : ((a.hb.Pb = a.Pb), (a.Pb.hb = a.hb));
    a.hb = null;
    a.Pb = this.c;
    this.c = this.c.hb = a;
    return a.Nc;
    ...
    ei = {},
      ...
      function a(a) {
        e ||
          ...
          (g = e.measureText("wmytzilWMYTZIL@#/&?$%10").width));
        var b = !0;
        "monospace" != a &&
          ((e.font = "32px " + a + ",monospace"),
          (b = e.measureText("wmytzilWMYTZIL@#/&?$%10").width != g),
          (e.font = "32px monospace"));
        return b;
      }
      function b() {
        ...
        if ((d = ug(d)))
          for (var e = 0, g = d.length; e < g; ++e) {
            ...
            h in c ||
              ((c[h] = 60),
              a(h) ||
                ((c[h] = 0), void 0 === f && (f = window.setInterval(b, 32))));
          }
      };
    })();
  function gi(a, b, c, d) {
    ...
    return function (c) {
      if (a.hasOwnProperty(c)) var d = a[c];
        ...
        if (ji.exec(d)) {
          ...
          0 == d.indexOf("rgba(")
            ? ((d = d.slice(5, -1).split(",").map(Number)), (f = oi(d)))
            : 0 == d.indexOf("rgb(")
  ...
  function oi(a) {
    var b = [];
    b[0] = oa((a[0] + 0.5) | 0, 0, 255);
    b[1] = oa((a[1] + 0.5) | 0, 0, 255);
    b[2] = oa((a[2] + 0.5) | 0, 0, 255);
    b[3] = oa(a[3], 0, 1);
    return b;
  }
  function pi(a) {
  ...
  function ui(a, b) {
    ...
    d
      ...
      : ((c.fillStyle = b.fillStyle), (a.G = { fillStyle: b.fillStyle }));
  }
  function vi(a, b) {
    var c = a.g,
      d = a.O;
  ...
  k.Oa = function (a, b) {
    a ? ((a = a.b), (this.a = { fillStyle: pi(a ? a : ai) })) : (this.a = null);
    if (b) {
      a = b.a;
      var c = b.f,
        d = b.g,
  ...
  k.kb = function (a) {
    if (a) {
      var b = a.Ea();
      b
        ? ((b = b.b), (this.j = { fillStyle: pi(b ? b : ai) }))
        : (this.j = null);
      var c = a.Fa();
      if (c) {
        b = c.a;
  ...
  function Fi(a, b) {
    ...
    void 0 !== b &&
      ("string" === typeof b
        ? (a.logos[b] = "")
        : b &&
          (na("string" == typeof b.href, 44),
          na("string" == typeof b.src, 45),
      ...
      for (q = x.fa; q <= x.la; ++q)
        for (r = x.ea; r <= x.ka; ++r)
          if (g - u <= h) {
            var z = b.$c(u, q, r, d, e);
            0 == z.getState() &&
              ((p[z.ib()] = !0), z.ib() in a.a || a.i([z, n, yc(c, z.xa), C]));
            void 0 !== l && l.call(m, z);
          } else b.jh(u, q, r, e);
    }
  }
  ...
  function Pi(a, b, c, d, e) {
    ...
    if (Tc(f, b)) {
      ...
      f.b(
        new Yh(
          b,
          new ri(c, d.pixelRatio, d.extent, a, d.viewState.rotation),
          d,
          c,
          null
        )
  ...
  Si.prototype.Cd = function (a, b) {
    ...
    l[0] ||
      l[1] ||
      $a(m) ||
      ((l = h.Y(m, g, c, e.projection)) && Di(this, l) && (this.N = l));
    this.N &&
      ((l = this.N),
      (e = l.C()),
      (b = l.resolution),
  ...
  k.Ga = function (a, b, c, d, e, f, g) {
    ...
    for (q = p.length - 1; 0 <= q; --q) {
      ...
      if (
        ...
        f.call(g, r) &&
        ((u = Yi(this, r)),
        r.ia() && (l = u.Ga(r.ia().D ? m : a, b, c, h, e)),
        l)
      )
        return l;
    }
  ...
  function Yi(a, b) {
    ...
    if (d) (a.c[c] = d), (a.v[c] = y(d, "change", a.Yl, a));
    else throw Error("Unable to create renderer for layer: " + b.T());
    return d;
  }
  k.Yl = function () {
    this.l.render();
  ...
  bj.prototype.Cd = function (a, b) {
    ...
    if (
      ...
      if ((Sa = this.context))
        (ma = l.Yd(p, c, f)),
          (Ja = Math.round(((x.la - x.fa + 1) * ma[0]) / r)),
          (ma = Math.round(((x.ka - x.ea + 1) * ma[1]) / r)),
          (pa = Sa.canvas),
          pa.width != Ja || pa.height != ma
            ? ((this.B = r), (pa.width = Ja), (pa.height = ma))
            : (this.c && !Ra(C, this.c) && Sa.clearRect(0, 0, Ja, ma),
              (r = this.B));
      this.f.length = 0;
  ...
  bj.prototype.Qf = function (a, b, c, d, e, f, g, h, l) {
    if ((c = a.Y(this.a))) {
      var m = w(this),
        n = l ? fj(a, m, b.time) : 1;
      1 !== n ||
        this.a.ia().cg(b.viewState.projection) ||
  ...
  (function (a) {
      ...
      for (h = h || d; g > f; ) {
        if (600 < g - f) {
          ...
          b(
            a,
            e,
            Math.max(f, Math.floor(e - (m * p) / l + n)),
            Math.min(g, Math.floor(e + ((l - m) * p) / l + n)),
            h
          );
        }
        l = a[e];
    ...
    function e(a, b) {
      ...
      this.vh = Math.max(2, Math.ceil(0.4 * this.Jf));
      b && this.vk(b);
      this.clear();
    }
    function f(a, b) {
    ...
    e.prototype = {
        ...
        for (var e = [], f, g, h, l; b; ) {
          ...
          for (g = b.children.length; f < g; f++)
            (h = b.children[f]),
              (l = b.cb ? d(h) : h),
              r(a, l) &&
                (b.cb ? c.push(h) : q(a, l) ? this.qh(h, c) : e.push(h));
          b = e.pop();
        }
        return c;
      },
        ...
        this.data.children.length
          ? this.data.height === a.height
            ...
            : (this.data.height < a.height &&
              ...
              this.uh(a, this.data.height - a.height - 1, !0))
          : (this.data = a);
        return this;
      },
      Ca: function (a) {
      ...
      remove: function (a, b) {
        if (!a) return this;
        for (
          var c = this.data, d = this.wb(a), e = [], f = [], g, h, l, m;
          c || e.length;
      ...
      qh: function (a, b) {
        for (var c = []; a; )
          a.cb ? b.push.apply(b, a.children) : c.push.apply(c, a.children),
            (a = c.pop());
        return b;
      },
      sh: function (a, b, c, d) {
        ...
        d ||
          ((d = Math.ceil(Math.log(e) / Math.log(g))),
      ...
      uh: function (a, b, c) {
        ...
        e.children.push(a);
        for (h(e, c); 0 <= b; )
          if (d[b].children.length > this.Jf) this.yk(d, b), b--;
          else break;
        this.pk(c, d, b);
      },
      yk: function (a, b) {
      ...
      rk: function (a, b, c) {
        ...
        for (d = b; d <= c - b; d++) {
          ...
          var m =
            Math.max(0, Math.min(h.la, l.la) - Math.max(h.fa, l.fa)) *
            Math.max(0, Math.min(h.ka, l.ka) - Math.max(h.ea, l.ea));
          h = n(h) + n(l);
          if (m < f) {
            f = m;
            var p = d;
  ...
  function kj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, x) {
    ...
    0 !== q
      ? ((f = c + f),
        (g = d + g),
        (x = df(C, f, g, 1, 1, q, -f, -g)),
        Na(a),
        Da(a, $e(C, [c, d])),
        Da(a, $e(C, [c + u, d])),
        Da(a, $e(C, [c + u, d + l])),
        Da(a, $e(C, [c, d + u])))
      : Ma(c, d, c + u * r, d + l * r, a);
    q = b.canvas;
    ...
    if (h) {
      if (q || 1 != h[4])
        Ta(h, a),
          h.push(
            q ? [b, x ? x.slice(0) : null, m, e, n, p, u, l, c, d, r] : null
          );
    ...
    if ("MultiPolygon" == d) {
      ...
      "Polygon" == d || "MultiLineString" == d
        ? ((h = []),
          ...
          oj(this, d, 0, a.ob(), e, h),
          this.a.push([4, f, h, a, c, Af]))
        : "LineString" == d || "MultiPoint" == d
        ? ((d = a.da()),
          (e = mj(this, d, 0, d.length, e, !1, !1)),
          this.a.push([4, f, e, a, c, zf]))
        : "Point" == d &&
          ((d = a.da()),
  ...
  function sj(a, b, c, d, e, f, g, h) {
    if (a.oa && gc(c, a.aa)) var l = a.oa;
      ...
      a.oa || (a.oa = []),
        (l = Se(a.coordinates, 0, a.coordinates.length, 2, c, a.oa)),
        Ze(a.aa, c);
    for (
      var m = !mb(e),
        n = 0,
      ...
      switch (N[0]) {
        case 0:
          var hc = N[1];
          (m && e[w(hc).toString()]) || !hc.V()
            ? (n = N[2])
            : void 0 === h || fb(h, hc.V().C())
            ? ++n
            : (n = N[2] + 1);
          break;
        case 1:
        ...
        case 4:
          ...
          se
            ? se(l, q, r, 2, of)
            : ((of[0] = l[q]), (of[1] = l[q + 1]), (of.length = 2));
          Qd(of, ma);
          ++n;
          break;
        case 6:
            ...
            a: {
              ...
              for (
                var Lg = sf[ue],
                  Mg = sf[ue + 1],
                  Jk = 0,
                  Ki = Math.sqrt(Math.pow(Lg - Gh, 2) + Math.pow(Mg - Hh, 2)),
                  Vf = "",
                  Kk = 0,
                  Li = 0;
                Li < np;
                ...
                for (var op = mp + Ng / 2; ue < kp - 2 && Jk + Ki < op; )
                  (Gh = Lg),
                    ...
                    (Jk += Ki),
                    (Ki = Math.sqrt(
                      Math.pow(Lg - Gh, 2) + Math.pow(Mg - Hh, 2)
                    ));
                var tu = op - Jk,
                ...
                var pp = tu / Ki,
                  ...
                  rp = wa(Hh, Mg, pp);
                Ji == Og
                  ? (Fh && ((Uf[0] = qp), (Uf[1] = rp), (Uf[2] = Ng / 2)),
                    (Uf[4] = Vf))
                  : ((Vf = Lk),
                    (Kk = Ng),
                    (Uf = [qp, rp, Ng / 2, Og, Vf]),
                    Fh ? Ik.unshift(Uf) : Ik.push(Uf),
                    (Ji = Og));
                mp += Ng;
              }
              Pg = Ik;
  ...
  k.Oa = function (a, b) {
    ...
    b
      ? ((a = b.a),
        (c.strokeStyle = pi(a ? a : ci)),
        (a = b.f),
        (c.lineCap = void 0 !== a ? a : "round"),
        (a = b.g),
        (c.lineDash = a ? a.slice() : bi),
        (a = b.i),
        ...
        c.lineWidth > this.O && ((this.O = c.lineWidth), (this.i = null)))
  ...
  function uj(a, b, c) {
    ...
    (b.Rk == d &&
      ...
      (c &&
        (void 0 != b.Zd &&
          b.Zd != a.coordinates.length &&
          (a.a.push([12]), (b.Zd = a.coordinates.length)),
        (b.Zd = 0)),
      a.a.push([11, d, l * a.pixelRatio, e, h, m, lj(a, f), g * a.pixelRatio]),
      c && a.a.push([1]),
      (b.Rk = d),
      (b.Lk = e),
      (b.Mk = f),
  ...
  function nj(a) {
    a.i ||
      ((a.i = Fa(a.ua)),
      0 < a.O && Ea(a.i, (a.resolution * (a.O + 1)) / 2, a.i));
    return a.i;
  }
  ...
  Dj.prototype.Wb = function (a, b) {
    ...
    if ("" !== this.sa && e && (c || d)) {
      ...
      if ("line" === e.placement) {
        ...
        switch (f) {
          ...
          case "MultiPolygon":
            ...
            for (a = f.length; g < a; g += 3)
              (e.exceedLength || f[g + 2] / this.resolution >= m) &&
                d.push(f[g], f[g + 1]);
            g = d.length;
            if (0 == g) return;
        }
        ...
        h = (h * l.width) / d + 2 * (0.5 - h) * m;
        a = (a * l.height) / d + 2 * (0.5 - a) * m;
        this.a.push([
          6,
          e,
          c,
  ...
  Dj.prototype.Y = function (a, b, c) {
    ...
    if (!di.a.hasOwnProperty(d)) {
      ...
      c &&
        ...
        (r.lineWidth = m * (kd ? h : 1)),
        (r.lineCap = e.lineCap),
        (r.lineJoin = e.lineJoin),
        (r.miterLimit = e.miterLimit),
        od &&
          e.lineDash.length &&
          (r.setLineDash(e.lineDash), (r.lineDashOffset = e.lineDashOffset)));
      ...
      if (c)
        for (c = 0; c < n; ++c)
          r.strokeText(a[c], h + e * p[c], 0.5 * m + c * q);
      if (b)
        for (c = 0; c < n; ++c) r.fillText(a[c], h + e * p[c], 0.5 * m + c * q);
    }
    return di.get(d);
  };
  function Gj(a, b, c, d) {
  ...
  Dj.prototype.kb = function (a, b) {
    ...
    if (a) {
      this.l = b;
      (d = a.Ea())
        ? ((b = this.c), b || (b = this.c = {}), (b.fillStyle = pi(d.b || ai)))
        : (b = this.c = null);
      if ((c = a.Fa())) {
        d = this.g;
        d || (d = this.g = {});
  ...
  function Lj(a, b, c, d, e) {
    for (
      var f = Object.keys(a).map(Number).sort(bc), g = 0, h = f.length;
      g < h;
      ++g
    )
  ...
  k.Ga = function (a, b, c, d, e, f, g) {
    ...
    d = Math.round(d);
    var l = 2 * d + 1,
      m = df(this.j, d + 0.5, d + 0.5, 1 / b, -1 / b, -c, -a[0], -a[1]),
      n = this.f;
  ...
  k.Ja = function (a, b) {
    ...
    c = a[b];
    void 0 === c &&
      ((c = new Pj[b](this.o, this.c, this.v, this.s, this.l, this.g)),
      (a[b] = c));
    return c;
  };
  k.wg = function () {
  ...
  k.Cd = function (a) {
    ...
    c.D &&
      h.projection.g &&
      !Ka(n, a.extent) &&
      ((a = Math.max(ab(f) / 2, ab(n))), (f[0] = n[0] - a), (f[2] = n[2] + a));
    if (!this.f && this.o == l && this.P == d && this.s == e && Ka(this.l, f))
      return !0;
    this.c = null;
    this.f = !1;
    var p = new Hj((0.5 * l) / m, f, l, m, c.aa, this.i, b.f);
    c.$d(f, l, g);
    a = function (a) {
      var c = a.fb();
  ...
  k.Cd = function (a, b) {
    ...
    this.H != d &&
      ((this.f.length = 0),
      (c = c.o),
      this.context || "vector" == c || (this.context = gg()),
      ...
      for (var ya = 0, fa = m.a.length; ya < fa; ++ya) {
        ...
        if (3 != pa.getState()) {
          ...
          var ib = Rj(V, p),
            jc = pa.a;
          u && u !== x.dh && jc.sort(u);
          for (var kc, pf = 0, Jg = jc.length; pf < Jg; ++pf)
            if (
              ((kc = jc[pf]),
              hc &&
                ("tile-pixels" == N.a && (N.Nj(Ja), N.Pi(pa.C())),
                kc.V().jb(N, q)),
              !Sa || fb(Sa, kc.C()))
            ) {
              var Qd = void 0,
      ...
      if ((p = Yj[n.o]) && q.eh !== r)
        for (
          q.eh = r,
            ...
            q = x.pixelRatio,
            rf = n.ia(),
            z = rf.bb(x.viewState.projection),
            r = z.Sa(V),
            u = bk(m, n),
            x = rf.Yd(V, q, x.viewState.projection),
            u.canvas.width = x[0],
            u.canvas.height = x[1],
            x = z.La(C),
            C = 0,
          ...
          if (3 != V.getState()) {
            ...
            if (!(fa = "vector" == g))
              a: {
                fa = void 0;
                for (fa in ya.b)
                  for (var pa = ya.b[fa], Ja = 0, ma = h.length; Ja < ma; ++Ja)
                    if (h[Ja] in pa) {
                      fa = !0;
                      break a;
                    }
    ...
    if (null !== a.alpha) {
      ...
      "boolean" === typeof a.absolute && a.absolute
        ...
        : "number" === typeof a.webkitCompassHeading &&
          ...
          this.set(gk, ua(a.webkitCompassHeading));
    }
  ...
  k.Rm = function () {
    if (qd) {
      var a = this.ii();
      a && !this.a
        ? (this.a = y(window, "deviceorientation", this.up, this))
  ...
  function lk(a, b) {
    ...
    if (void 0 === b) {
      ...
      a.Ya
        ? (a.D = a.o)
        : ((n = gg(c.size, c.size)), (a.D = n.canvas), a.Fh(c, n, 0, 0));
    } else (m = Math.round(m)), (d = !a.Ya) && (n = a.Fh.bind(a, c)), a.Wa ? ((e = a.Wa), void 0 === e.b && ((e.b = "s"), (e.b = e.a ? ("string" === typeof e.a ? e.b + e.a : e.b + w(e.a).toString()) : e.b + "-"), (e.b += "," + (void 0 !== e.f ? e.f.toString() : "-") + "," + (e.g ? e.g.toString() : "-") + "," + (void 0 !== e.i ? e.i : "-") + "," + (void 0 !== e.j ? e.j : "-") + "," + (void 0 !== e.l ? e.l.toString() : "-") + "," + (void 0 !== e.c ? e.c.toString() : "-"))), (e = e.b)) : (e = "-"), a.Ya ? ((f = a.Ya), void 0 === f.a && (f.a = f.b instanceof CanvasPattern || f.b instanceof CanvasGradient ? w(f.b).toString() : "f" + (f.b ? ni(f.b) : "-")), (f = f.a)) : (f = "-"), (a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.g == a.c[4] && a.j == a.c[5] && a.l == a.c[6]) || (a.c = ["r" + e + f + (void 0 !== a.b ? a.b.toString() : "-") + (void 0 !== a.g ? a.g.toString() : "-") + (void 0 !== a.j ? a.j.toString() : "-") + (void 0 !== a.l ? a.l.toString() : "-"), e, f, a.b, a.g, a.j, a.l]), (n = b.add(a.c[0], m, m, a.Gh.bind(a, c), n)), (a.o = n.image), (a.oa = [n.offsetX, n.offsetY]), (b = n.image.width), (a.D = d ? n.sm : a.o);
    a.B = [m / 2, m / 2];
    a.qa = [m, m];
    a.H = [b, b];
  }
  ...
  nk.prototype.clone = function () {
    var a = this.b;
    return new nk({ color: a && a.slice ? a.slice() : a || void 0 });
  };
  ...
  function tk() {
    if (!sk) {
      var a = new nk({ color: "rgba(255,255,255,0.4)" }),
        b = new ok({ color: "#3399CC", width: 1.25 });
      sk = [
        new pk({
          image: new mk({ fill: a, stroke: b, radius: 5 }),
          fill: a,
          stroke: b,
        }),
      ];
  ...
  function uk() {
    var a = {},
      b = [255, 255, 255, 1],
      c = [0, 153, 255, 1];
    a.Polygon = [new pk({ fill: new nk({ color: [255, 255, 255, 0.5] }) })];
    a.MultiPolygon = a.Polygon;
    a.LineString = [
      new pk({ stroke: new ok({ color: b, width: 5 }) }),
      new pk({ stroke: new ok({ color: c, width: 3 }) }),
    ];
    ...
    a.Point = [
      new pk({
        image: new mk({
          radius: 6,
          fill: new nk({ color: c }),
          stroke: new ok({ color: b, width: 1.5 }),
        }),
        zIndex: Infinity,
      }),
    ];
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ga(this.C(), a, b)) return d;
    this.o != this.g &&
      ((this.D = Math.sqrt(qf(this.A, 0, this.A.length, this.a, 0))),
      (this.o = this.g));
  ...
  k.Kn = function (a, b) {
    return "XYM" != this.ja && "XYZM" != this.ja
      ? null
      : zk(this.A, 0, this.A.length, this.a, a, void 0 !== b ? b : !1);
  };
  k.U = function () {
    return zf(this.A, 0, this.A.length, this.a);
  };
  ...
  k.Ee = function () {
    this.j != this.g && ((this.c = this.Mh(0.5, this.c)), (this.j = this.g));
    return this.c;
  };
  k.vd = function (a) {
    var b = [];
    ...
    for (
      ...
      (x = n.pop()),
        ...
        sa(u[0], u[1], g[0], g[1], h[0], h[1]) < c
          ? (d.push(h[0], h[1]), (f = C.toString()), (p[f] = !0))
          : (n.push(C, z, z, x), m.push(h, u, u, g), l.push(f, r, r, e));
    return d;
  }
  ...
  function Fk(a) {
    ...
    1 == a.showLabels &&
      ...
      (this.W = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition),
      (this.H =
        void 0 !== a.lonLabelStyle
          ...
          : new Ek({
              ...
              textBaseline: "bottom",
              fill: new nk({ color: "rgba(0,0,0,1)" }),
              stroke: new ok({ color: "rgba(255,255,255,1)", width: 3 }),
            })),
      (this.B =
  ...
  function Pk(a, b, c, d, e, f, g) {
    ...
    fb(h.C(), f) &&
      (a.b &&
        ...
        (c = void 0 !== a.b[c] ? a.b[c].Pd : new B(null)),
        c.na(f),
        (a.b[g] = { Pd: c, text: a.aa(b) })),
      (a.g[g++] = h));
    return g;
  }
  function Qk(a, b, c, d, e, f, g) {
    ...
    fb(h.C(), f) &&
      (a.a &&
        ...
        (f = [
          oa(
            f[0] + Math.abs(f[0] - f[2]) * a.W,
            Math.max(f[0], d[0]),
            Math.min(f[2], d[d.length - 2])
          ),
          d[1],
        ]),
        (c = void 0 !== a.a[c] ? a.a[c].Pd : new B(null)),
        c.na(f),
        (a.a[g] = { Pd: c, text: a.Va(b) })),
      (a.c[g++] = h));
    return g;
  }
  k = Fk.prototype;
  ...
  k.bn = function () {
    void 0 === this.resolution &&
      (this.resolution = bb(this.extent) / this.N.height);
    this.state = 2;
    this.g.forEach(Gc);
    this.g = null;
    this.u();
  ...
  k.load = function () {
    if (0 == this.state || 3 == this.state)
      (this.state = 1),
        this.u(),
        (this.g = [
          Lc(this.N, "error", this.an, this),
          Lc(this.N, "load", this.bn, this),
        ]),
        this.c(this, this.i);
  };
  k.hh = function (a) {
  ...
  k.load = function () {
    if (0 == this.state || 3 == this.state)
      (this.state = 1),
        this.u(),
        (this.c = [
          Lc(this.N, "error", this.Zm, this),
          Lc(this.N, "load", this.$m, this),
        ]),
        this.l(this, this.f);
  };
  function Wk(a) {
  ...
  k.Oa = function (a, b) {
    ...
    a instanceof CanvasGradient || a instanceof CanvasPattern
      ? (a = il)
      : (a =
          li(a).map(function (a, b) {
            return 3 != b ? a / 255 : a;
          }) || il);
    (this.c.strokeColor &&
      gc(this.c.strokeColor, c) &&
      this.c.fillColor &&
      gc(this.c.fillColor, a) &&
      this.c.lineWidth === b) ||
      ((this.c.u = !0),
      (this.c.fillColor = a),
  ...
  function xl(a, b) {
    ...
    (this.f = cc(ca, "OES_element_index_uint")) &&
  ...
  k.Zb = function (a) {
    ...
    0 === this.c.length
      ...
      : ((n = this.c[this.c.length - 1]),
        w(n) != w(e) && (this.o.push(this.b.length), this.c.push(e)));
    this.D = b[0];
    this.B = b[1];
    this.height = m[1];
    this.oa = d[1];
  ...
  function Ml(a, b, c, d) {
    ...
    m &&
      ((q = q || f / 7),
      (z = Nf([r[0], r[1], u[0], u[1], x[0], x[1]], 0, 6, 2) ? 1 : -1),
      (f = Nl(a, r, u, x, z * Sl * (h || 1), f)),
  ...
  k.tc = function (a, b) {
    ...
    a = a.pa();
    Wl(c, 0, c.length, a) &&
      ((c = Te(c, 0, c.length, a, -this.origin[0], -this.origin[1])),
      this.c.u && (this.l.push(this.b.length), (this.c.u = !1)),
      this.g.push(this.b.length),
      this.i.push(b),
      Ml(this, c, c.length, a));
  };
  k.uc = function (a, b) {
    var c = this.b.length,
      d = a.ob();
  ...
  function Xl(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (e = c.length; b < e; ++b)
        Hl(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])),
          Ml(a, c[b], c[b].length, d);
    }
  }
  function Yl(a, b, c) {
    ...
    if (mb(c)) {
      ...
      for (h = this.l.length - 1; 0 <= h; --h) {
        ...
        for (n = this.l[h]; 0 <= m && this.g[m] >= n; ) {
          ...
          q = w(q).toString();
          c[q] &&
            (g !== l && (hl(a, b, g, l), a.clear(a.DEPTH_BUFFER_BIT)), (l = p));
          m--;
          g = p;
        }
  ...
  function rm(a, b, c, d) {
    ...
    if (c.length) {
      ...
      for (g = c.length; l < g; ++l) {
        var m = { list: new cm(), Cc: void 0, fh: new km() };
        h.push(m);
      ...
      for (l = 0; l < h.length; ++l) {
        ...
        !n &&
          wm(c, h[l].Cc[0], e, b[0], f) &&
          (f.concat(h[l].fh), um(e, f, !1));
      }
    } else um(e, f, !1);
    xm(a, e, f);
  }
  function sm(a, b, c, d, e, f) {
    ...
    } else for (p = b.length - c, n = f = ym(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c) (q = ym(a, b[p], b[p + 1], h++)), m.push(zm(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]), (n = q);
    m.push(zm(q, f, d));
    l.push([
      Math.min(n.x, q.x),
      Math.min(n.y, q.y),
  ...
  function tm(a) {
    var b = em(a),
      c = b,
      d = [c.Z.x, c.Z.y];
    do (c = fm(a)), c.Z.x > d[0] && (d = [c.Z.x, c.Z.y]);
    while (c !== b);
    return d;
  }
  function um(a, b, c) {
    ...
    do {
      var h = c
        ? ll(f.X.x, f.X.y, e.X.x, e.X.y, e.Z.x, e.Z.y)
        : ll(e.Z.x, e.Z.y, e.X.x, e.X.y, f.X.x, f.X.y);
      void 0 === h
        ? (Am(e, f, a, b), (g = !0), f === d && (d = gm(a)), (f = e), hm(a))
  ...
  function Em(a, b, c, d, e) {
    ...
    do {
      ...
      if (!1 === r.Kb) {
        var x = d
          ? 0 === Cm(q, r, u, c, !0).length
          : e
          ? Gm(n.X, u, r, q, h.Z)
          : Gm(h.Z, q, r, u, n.X);
        (!d && 0 !== vm({ Z: q, X: u }, c).length) ||
          !x ||
          (!d &&
            !1 !== q.Kb &&
            !1 !== u.Kb &&
  ...
  function Fm(a, b, c, d) {
    ...
    do {
      ...
      if (l) {
        ...
        d
          ? (l[0] === f.Z.x && l[1] === f.Z.y
              ? (hm(b), (l = f.Z), (g.Z = l), c.remove(f), (p = p || f === e))
    ...
    for (f = l.length; d < f; ++d)
      for (g in l[d]) {
        ...
        "object" !== typeof m ||
          ...
          (m.x === c.x && m.y === c.y) ||
          -1 !== h.indexOf(m) ||
          !Hf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, m.x, m.y) ||
          h.push(m);
      }
    return h;
  }
  ...
  k.Oa = function (a, b) {
    ...
    (this.l.fillColor && gc(a, this.l.fillColor)) ||
      ((this.l.fillColor = a), (this.l.u = !0), this.o.push(a));
    b
      ? this.f.Oa(null, b)
      : this.f.Oa(null, new ok({ color: [0, 0, 0, 0], lineWidth: 0 }));
  };
  function Hm(a, b) {
    this.b = b;
      ...
      for (g = b.length; f < g; ++f) {
        ...
        for (h = r.length; u < h; ++u) {
          ...
          if (x) {
            ...
            0 === this.c.length
              ? this.c.push(z)
              : ((x = this.c[this.c.length - 1]),
                w(x) != w(z) && (this.v.push(this.b.length), this.c.push(z)));
            x = c;
            C = d;
            var E = e;
  ...
  k.kb = function (a) {
    ...
    if (a && a.Ka() && (c || d)) {
      ...
      d = Cj[a.f];
      c = Cj[a.j];
      this.mb = void 0 === d ? 0.5 : d;
      this.ua = void 0 === c ? 0.5 : c;
      this.aa = a.g || 0;
      this.ca = a.c || 0;
      ...
      if (
        ...
        Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1])
          ? ((r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2]),
            ...
            (p = a.a(n)),
            kn(a, b, c, r, n, f, g, q, p, m - 1),
            kn(a, n, r, d, e, p, q, h, l, m - 1))
          : ((r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2]),
            (q = a.a(r)),
            (n = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2]),
            (p = a.a(n)),
            kn(a, b, r, n, e, f, q, p, l, m - 1),
  ...
  function mn(a, b, c, d, e, f) {
    ...
    var g = b.C(),
      h = g ? eb(c, g) : c;
    g = fn(a, b, cb(h), d);
    this.f = new jn(a, b, h, this.l, 0.5 * g);
    this.c = d;
    this.g = c;
    a = ln(this.f);
  ...
  mn.prototype.fe = function () {
    ...
    2 == a &&
      (this.i = hn(
        ...
        this.g,
        this.f,
        [{ extent: this.Tb.C(), image: this.Tb.Y() }],
        0
      ));
    this.state = a;
    this.u();
  ...
  xn.prototype.Vc = function (a, b, c, d) {
    ...
    a = a.slice();
    gb(a, this.Xa);
    (d = this.ya(a, b, c, [(ab(a) / b) * c, (bb(a) / b) * c], d)) &&
      (e = new en(a, b, c, d));
    this.aa = e;
    this.ca = this.g;
    return e;
  ...
  k.Hk = function (a, b, c, d, e) {
    var f = new Hj((0.5 * b) / c, a, b, c, this.a.aa, this.G, this.nb);
    this.a.$d(a, b, e);
    var g = !1;
    this.a.dc(
      a,
  ...
  An.prototype.Ag = function (a, b) {
    ...
    l &&
      ((c = this.c.i.j),
      Cn(this, c.width, c.height, d, f, g, h, l.C()),
      (this.l = null),
      (d = this.v),
      We(d),
      bf(d, 1, -1),
  ...
  function En(a, b, c, d) {
    ...
    if (a.a.a.hasOwnProperty(f))
      (a = a.a.get(f)),
        ...
        9729 != a.ei && (e.texParameteri(3553, 10240, 9729), (a.ei = 9729)),
        9729 != a.gi && (e.texParameteri(3553, 10241, 9729), (a.gi = 9729));
    else {
      ...
      if (0 < d) {
        var h = a.B.canvas,
          l = a.B;
        a.D !== c[0] || a.P !== c[1]
          ? ((h.width = c[0]), (h.height = c[1]), (a.D = c[0]), (a.P = c[1]))
  ...
  k.Uk = function (a, b) {
    ...
    for (var c; 1024 < this.a.i - this.f; ) {
      if ((c = this.a.g.Nc)) a.deleteTexture(c.Mb);
  ...
  k.ah = function (a) {
    ...
    0 !== this.j.b.length &&
      (a.postRenderFunctions.push(this.H), (a.animate = !0));
  ...
  k.Ag = function (a, b, c) {
    ...
    Hi(
      ...
      function (a) {
        2 != a.getState() ||
          d.a.a.hasOwnProperty(a.ib()) ||
          a.ib() in kc.a ||
          kc.i([a, yc(m, a.xa), m.Sa(a.xa[0]), q, x * r]);
      },
      this
    );
    Ei(a, l);
    ...
    cf(
      e,
      (Math.round(C[0] / p) * p - u[0]) / (u[2] - u[0]),
      (Math.round(C[1] / p) * p - u[1]) / (u[3] - u[1])
    );
  ...
  function Sn(a) {
    ...
    if (b && b.c && c) {
      ...
      if ("bottom-right" == f || "center-right" == f || "top-right" == f)
        "" !== a.a.Re && (a.a.Re = b.left = ""),
          (g = Math.round(d[0] - c[0] - g) + "px"),
          a.a.vf != g && (a.a.vf = b.right = g);
      else {
  ...
  k.load = function () {
    0 == this.state &&
      (dj(this, 1), this.B(this, this.P), this.D(null, NaN, null));
  };
  k.tp = function (a, b, c) {
    this.tg(b);
    this.Dj(a);
  ...
  function Xn(a) {
    ...
    c = document.createElement("div");
    c.className =
      this.c + " ol-unselectable ol-control " + (Zn() ? "" : "ol-unsupported");
    c.appendChild(b);
    tg.call(this, { element: c, target: a.target });
  ...
  Xn.prototype.o = function () {
    var a = this.element.firstElementChild,
      b = this.a;
    Yn()
      ? ((a.className = this.c + "-true"), hg(this.v, this.l))
      : ((a.className = this.c + "-false"), hg(this.l, this.v));
    b && b.Mc();
  };
  ...
  k.setMap = function (a) {
    ...
    a &&
      ((a = a.a),
      this.s.push(
        y(a, "mousemove", this.dm, this),
        y(a, "mouseout", this.em, this)
      ));
  };
  k.Bj = function (a) {
    this.set(go, a);
  ...
  k.setMap = function (a) {
    ...
    a !== b &&
      (b &&
        ((b = b.$()) && Mc(b, Xc("rotation"), this.Pe, this), this.c.yd(null)),
      tg.prototype.setMap.call(this, a),
      a &&
        (this.c.yd(this.B),
        this.s.push(y(a, "propertychange", this.cm, this)),
        0 === this.c.We().jc() && this.c.xf(a.gc()),
        (a = a.$()))) &&
      (y(a, Xc("rotation"), this.Pe, this), $f(a) && (this.c.Mc(), jo(this)));
  };
  k.cm = function (a) {
    "view" === a.key &&
      ((a = a.oldValue) && Mc(a, Xc("rotation"), this.Pe, this),
      (a = this.a.$()),
  ...
  function io() {
    ...
    if (a.c && b.c) {
      ...
      b < 0.1 * f || e < 0.1 * d || b > 0.75 * f || e > 0.75 * d
        ? jo(this)
        : Ka(c, a) || ((a = this.c), (c = this.a.$()), a.$().tb(c.wa()));
    }
    ko(this);
  }
  function jo(a) {
    ...
    b = b.$().od(c);
    a = a.$();
    gb(b, 1 / (0.1 * Math.pow(2, Math.log(7.5) / Math.LN2 / 2)));
    a.Sf(b);
  }
  function ko(a) {
    var b = a.a,
  ...
  k.Pl = function (a) {
    if (this.o) {
      ...
      this.c = vo(
        ...
        oa(
          1 === this.j
            ? (a.clientX - this.B + parseInt(b.style.left, 10)) / this.D
            : (a.clientY - this.H + parseInt(b.style.top, 10)) / this.v,
          0,
          1
        )
      );
  ...
  function Ao(a, b, c) {
    if (a.nodeType == Node.CDATA_SECTION_NODE || a.nodeType == Node.TEXT_NODE)
      b
        ...
        : c.push(a.nodeValue);
    else for (a = a.firstChild; a; a = a.nextSibling) Ao(a, b, c);
    return c;
  }
  function Bo(a) {
      ...
      h.onload = function () {
        if (!h.status || (200 <= h.status && 300 > h.status)) {
          ...
          if ("json" == a || "text" == a) var e = h.responseText;
            ...
            "xml" == a
              ? (e = h.responseXML) || (e = Do(h.responseText))
              : "arraybuffer" == a && (e = h.response);
          e
            ? c.call(this, b.Na(e, { featureProjection: g }), b.rb(e), b.ag())
            : d.call(this);
        } else d.call(this);
      }.bind(this);
      h.onerror = function () {
  ...
  k.Nb = function (a, b, c, d) {
    if (d < Ga(this.C(), a, b)) return d;
    this.j != this.g &&
      ((this.o = Math.sqrt(tf(this.A, 0, this.c, this.a, 0))),
      (this.j = this.g));
  ...
  k.clone = function () {
    for (
      var a = new R(null), b = this.c.length, c = Array(b), d = 0;
      d < b;
      ++d
    )
      c[d] = this.c[d].slice();
  ...
  function $o(a, b) {
    ...
    if ("number" === typeof a.x && "number" === typeof a.y) var c = "Point";
      ...
      for (h = d.length; l < h; ++l)
        (f.length = 0),
          xf(f, 0, d[l], e.length),
          Nf(f, 0, f.length, e.length) ? g.push([d[l]]) : c.push(d[l]);
      for (; c.length; ) {
        d = c.shift();
        e = !1;
  ...
  var up = {
      Point: function (a) {
        return void 0 !== a.m && void 0 !== a.z
          ? new B([a.x, a.y, a.z, a.m], "XYZM")
          : void 0 !== a.z
          ? new B([a.x, a.y, a.z], "XYZ")
          : void 0 !== a.m
          ? new B([a.x, a.y, a.m], "XYM")
          : new B([a.x, a.y]);
      },
    ...
    wp = {
      ...
      LineString: function (a) {
        var b = vp(a);
        return { hasZ: b.hasZ, hasM: b.hasM, paths: [a.U()] };
      },
      Polygon: function (a) {
        var b = vp(a);
        return { hasZ: b.hasZ, hasM: b.hasM, rings: a.U(!1) };
      },
      MultiPoint: function (a) {
        var b = vp(a);
        return { hasZ: b.hasZ, hasM: b.hasM, points: a.U() };
      },
      MultiLineString: function (a) {
        var b = vp(a);
        return { hasZ: b.hasZ, hasM: b.hasM, paths: a.U() };
  ...
  k.Sg = function (a) {
    return a.spatialReference && a.spatialReference.wkid
      ? Nb("EPSG:" + a.spatialReference.wkid)
      : null;
  };
  function xp(a, b) {
      ...
      for (var u in g) {
        ...
        for (h = f.length; l < h; ++l)
          (-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u &&
            (n[f[l].split(":").pop()] =
              "featureMembers" == c ? Fo(this.Jg, this) : Go(this.Jg, this));
        e[g[u]] = n;
      }
  ...
  k.Og = function (a, b) {
    ...
    a.getAttribute("srsDimension")
      ? (d = Jp(a.getAttribute("srsDimension")))
      : a.getAttribute("dimension")
      ? (d = Jp(a.getAttribute("dimension")))
      : a.parentNode.getAttribute("srsDimension")
      ? (d = Jp(a.parentNode.getAttribute("srsDimension")))
      : e && (d = Jp(e));
  ...
  k.ik = {
    "http://www.opengis.net/gml": { PolygonPatch: Go(Op.prototype.Yp) },
  };
  k.lk = {
    "http://www.opengis.net/gml": { LineStringSegment: Go(Op.prototype.Sp) },
  };
  function Pp(a, b, c) {
    var d = c[c.length - 1];
    c = d.hasZ;
  ...
  var Qp = {
    "http://www.opengis.net/gml": { lowerCorner: L(Lp), upperCorner: L(Lp) },
  };
  k = Op.prototype;
  k.Gn = function (a, b, c) {
    var d = c[c.length - 1].srsName;
  ...
  k.$e = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((b = b.Td()),
        Oo({ node: a, hasZ: e, srsName: d }, Rp, this.Fn, b, c, void 0, this))
      : "Surface" === a.nodeName &&
        ((e = yo(a.namespaceURI, "patches")),
        a.appendChild(e),
        (a = yo(e.namespaceURI, "PolygonPatch")),
        e.appendChild(a),
        this.$e(a, b, c));
  };
  k.Ze = function (a, b, c) {
    ...
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((d = yo(a.namespaceURI, "posList")), a.appendChild(d), Pp(d, b, c))
      : "Curve" === a.nodeName &&
        ((d = yo(a.namespaceURI, "segments")),
        a.appendChild(d),
        (a = yo(d.namespaceURI, "LineStringSegment")),
        d.appendChild(a),
        this.Ze(a, b, c));
  };
  k.Di = function (a, b, c) {
  ...
  k.Yc = function (a, b, c) {
    ...
    Array.isArray(b)
      ? d.dataProjection
        ? (f = $b(b, d.featureProjection, d.dataProjection))
        : (f = b)
      : (f = Uo(b, !0, d));
  ...
  k.zi = function (a, b, c) {
    ...
    for (m in g) {
      ...
      null !== l &&
        ...
        h.push(l),
        m == f || l instanceof ff
          ? m in d.sb[e] || (d.sb[e][m] = L(this.Yc, this))
          : m in d.sb[e] || (d.sb[e][m] = L(Lp)));
    }
    var m = jb({}, d);
    m.node = a;
  ...
  k.Xe = function (a, b, c) {
    ...
    "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
    "LineString" === a.nodeName || "LineStringSegment" === a.nodeName
      ? ((d = Zp(a.namespaceURI)), a.appendChild(d), $p(d, b, c))
      : "Curve" === a.nodeName &&
        ((d = yo(a.namespaceURI, "segments")),
        a.appendChild(d),
        (a = yo(d.namespaceURI, "LineStringSegment")),
  ...
  k.Ye = function (a, b, c) {
    ...
    "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName
      ? ((b = b.Td()),
        Oo({ node: a, hasZ: e, srsName: d }, bq, this.Bn, b, c, void 0, this))
      : "Surface" === a.nodeName &&
        ((e = yo(a.namespaceURI, "patches")),
        a.appendChild(e),
        (a = yo(e.namespaceURI, "PolygonPatch")),
  ...
  function oq(a, b) {
    var c = b[0];
    if ((a = O({ flatCoordinates: [], layoutOptions: {} }, pq, a, b))) {
      b = a.flatCoordinates;
  ...
  function qq(a, b) {
    var c = b[0];
    if (
      (a = O({ flatCoordinates: [], ends: [], layoutOptions: {} }, rq, a, b))
    ) {
      b = a.flatCoordinates;
      delete a.flatCoordinates;
      var d = a.ends;
  ...
  var uq = { rte: oq, trk: qq, wpt: sq },
    ...
    pq = M(iq, {
      ...
      rtept: function (a, b) {
        var c = O({}, wq, a, b);
        c &&
          ((b = b[b.length - 1]), jq(b.flatCoordinates, b.layoutOptions, a, c));
      },
    }),
  ...
  hq.prototype.Ic = function (a, b) {
    return cc(iq, a.namespaceURI)
      ? "gpx" == a.localName && (a = O([], vq, a, [So(this, a, b)]))
        ? (zq(this, a), a)
        : []
      : [];
  };
  ...
  var Pq = M(iq, {
    ...
    wpt: L(function (a, b, c) {
      ...
      e.properties = b.M();
      if ((b = b.V()))
        (b = Uo(b, !0, d)), (e.geometryLayout = b.ja), Dq(a, b.U(), c);
    }),
  });
  ...
  k.Vd = function (a) {
    ...
    if (e)
      return (
        (a = new Qq(null)), Tq(a), (a.a = c), Rq(a), a.u(), (this.i[b] = a)
      );
    this.f = a;
    return this;
  };
  ...
  var Wq = {
    ...
    Yq = {
      Point: function (a) {
        return { type: "Point", coordinates: a.U() };
      },
      LineString: function (a) {
        return { type: "LineString", coordinates: a.U() };
      },
      Polygon: function (a, b) {
        if (b) var c = b.rightHanded;
        return { type: "Polygon", coordinates: a.U(c) };
      },
      MultiPoint: function (a) {
        return { type: "MultiPoint", coordinates: a.U() };
      },
      MultiLineString: function (a) {
        return { type: "MultiLineString", coordinates: a.U() };
      },
      MultiPolygon: function (a, b) {
        if (b) var c = b.rightHanded;
        return { type: "MultiPolygon", coordinates: a.U(c) };
      },
      GeometryCollection: function (a, b) {
        return {
  ...
  k.cd = function (a, b) {
    ...
    this.b
      ? c.Jc(this.b)
      : this.a && void 0 !== a.geometry_name && c.Jc(a.geometry_name);
    c.Ua(b);
  ...
  fr.prototype.o = function () {
    ...
    if (!this.s && null !== this.f) {
      ...
      for (
        var b = a.getImageData(0, 0, this.N.width, this.N.height),
          c = b.data,
          d = this.f[0] / 255,
          e = this.f[1] / 255,
          f = this.f[2] / 255,
  ...
  fr.prototype.load = function () {
    if (0 == this.g) {
      this.g = 1;
      this.i = [
        Lc(this.N, "error", this.v, this),
        Lc(this.N, "load", this.o, this),
      ];
      try {
        this.N.src = this.l;
      } catch (a) {
  ...
  function ir(a) {
    ...
    jr ||
      ...
      (nr = or = "pixels"),
      (pr = [64, 64]),
      (qr = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png"),
      (rr = 0.5),
      (sr = new hr({
        anchor: mr,
      ...
      (tr = "NO_IMAGE"),
      (ur = new ok({ color: kr, width: 1 })),
      (vr = new ok({ color: [51, 51, 51, 1], width: 2 })),
      (wr = new Ek({
      ...
      (xr = new pk({ fill: lr, image: sr, text: wr, stroke: ur, zIndex: 0 })),
      (jr = [xr]));
    this.defaultDataProjection = Nb("EPSG:4326");
  ...
  function Qr(a, b) {
    ...
    if (c)
      if ("Point" == d) {
        ...
        "LineString" == d
          ? ((g = new P(null)), Xo(g, a), Sr(g, a))
          : "Polygon" == d
          ? ((g = new R(null)), Yo(g, a), Sr(g, a))
  ...
  function Wr(a, b) {
    ...
    b = b.outline;
    void 0 === b || b || (e = null);
    return [new pk({ fill: a, image: c, stroke: e, text: d, zIndex: void 0 })];
  }
  function Sr(a, b) {
    var c = b.length,
      d = Array(b.length),
  ...
  var bs = M(zr, { displayName: K(S), value: K(S) }),
    ...
    hs = M(
      zr,
      { href: K(Gr) },
      M(yr, { x: K(Gp), y: K(Gp), w: K(Gp), h: K(Gp) })
    ),
    is = M(zr, {
      Icon: K(function (a, b) {
    ...
    Xr = M(zr, {
      ...
      LabelStyle: function (a, b) {
        (a = O({}, js, a, b)) &&
          (b[b.length - 1].textStyle = new Ek({
            fill: new nk({ color: "color" in a ? a.color : kr }),
            scale: a.scale,
          }));
      },
      LineStyle: function (a, b) {
        (a = O({}, ks, a, b)) &&
          (b[b.length - 1].strokeStyle = new ok({
      ...
      PolyStyle: function (a, b) {
        if ((a = O({}, rs, a, b))) {
          b = b[b.length - 1];
          b.fillStyle = new nk({ color: "color" in a ? a.color : kr });
          var c = a.fill;
          void 0 !== c && (b.fill = c);
          a = a.outline;
  ...
  k.Kg = function (a, b) {
    return cc(zr, a.namespaceURI)
      ? (a = this.Qg(a, [So(this, a, b)]))
        ? a
        : null
      : null;
  };
  ...
  k.Wp = function (a) {
    ...
    Bo(a)
      ...
      : Co(a)
      ? ec(b, vs(this, a))
      : "string" === typeof a && ((a = Do(a)), ec(b, us(this, a)));
    return b;
  };
  function us(a, b) {
    var c = [];
  ...
  k.Zp = function (a) {
    ...
    Bo(a)
      ...
      : Co(a)
      ? ec(b, this.tf(a))
      : "string" === typeof a && ((a = Do(a)), ec(b, ws(this, a)));
    return b;
  };
  function ws(a, b) {
    var c = [];
  ...
  function ys(a, b, c) {
    ...
    if ("GeometryCollection" == d) {
      var e = b.td();
      var f = zs;
    } else "MultiPoint" == d ? ((e = b.be()), (f = As)) : "MultiLineString" == d ? ((e = b.ud()), (f = Bs)) : "MultiPolygon" == d ? ((e = b.Ud()), (f = Cs)) : na(!1, 39);
    Oo(a, Ds, f, e, c);
  }
  function Es(a, b, c) {
    Oo({ node: a }, Fs, Gs, [b], c);
  ...
  var Ts = M(zr, ["Document", "Placemark"]),
    Ws = M(zr, {
      Document: L(function (a, b, c) {
        Oo({ node: a }, Us, Vs, b, c, void 0, this);
      }),
      Placemark: L(Hs),
    }),
    ...
    Xs = M(zr, {
      Data: L(function (a, b, c) {
        ...
        "object" == typeof b
          ? (null !== b &&
              b.displayName &&
              Oo(a, Xs, Lo, [b.displayName], c, ["displayName"]),
            null !== b && b.value && Oo(a, Xs, Lo, [b.value], c, ["value"]))
          : Oo(a, Xs, Lo, [b], c, ["value"]);
      }),
    ...
    $s = M(
      zr,
      { href: L(Lp) },
      M(yr, { x: L(Mp), y: L(Mp), w: L(Mp), h: L(Mp) })
    ),
    ...
    Is = M(zr, {
      ExtendedData: L(function (a, b, c) {
        ...
        for (var e = d.length, f = 0; f < e; f++)
          Oo(a, Xs, ht, [{ name: d[f], value: b[f] }], c);
      }),
      MultiGeometry: L(ys),
      LineString: L(Ls),
      LinearRing: L(Ls),
  ...
  (function (a) {
    ...
    b.prototype = {
      ...
      Ug: function () {
        for (
          var a = this.Ta() + this.ga, b = this.sc, c = "", d = this.ga;
          d < a;
      ...
      Aq: function (a) {
        a &= 7;
        if (a === b.c) for (; 127 < this.sc[this.ga++]; );
  ...
  k.C = function () {
    this.i ||
      (this.i =
        "Point" === this.f ? Oa(this.b) : Pa(this.b, 0, this.b.length, 2));
    return this.i;
  };
  k.Sd = function () {
    if (!this.c) {
  ...
  k.Ee = function () {
    this.a || (this.a = yk(this.b, 0, this.b.length, 2, 0.5));
    return this.a;
  };
  k.Fe = function () {
    if (!this.a) {
  ...
  function rt(a, b, c) {
    ...
    var x;
    1 === d
      ? (x = 1 === b ? "Point" : "MultiPoint")
      : 2 === d
      ? (x = 1 === b ? "LineString" : "MultiLineString")
      : 3 === d && (x = "Polygon");
    d = x;
    if (a.b === mt) g = new a.b(d, g, h, f, e);
    else {
      if ("Polygon" == d) {
        d = [];
        l = b = x = 0;
        for (c = h.length; l < c; ++l)
          (m = h[l]),
            Nf(g, x, m, 2) || (d.push(h.slice(b, l)), (b = l)),
            (x = m);
  ...
  Et.prototype.Lg = function (a, b) {
    if ("Topology" == a.type) {
      ...
      g = this.a;
      for (var z in a)
        (this.b && -1 == this.b.indexOf(z)) ||
          ("GeometryCollection" === a[z].type
            ? ((l = a[z]), e.push.apply(e, Gt(l, f, c, d, g, z, b)))
            : ((l = a[z]), e.push(Ht(l, f, c, d, g, z, b))));
      return e;
    }
    return [];
  };
  ...
  var Au = {
    "http://www.opengis.net/gml": { boundedBy: K(Bp.prototype.pf, "bounds") },
  };
  function zu(a, b) {
    var c = {},
  ...
  var Hu = {
    "http://www.opengis.net/wfs": {
        ...
        if (2 === e) {
          ...
          for (n in h) {
            ...
            null !== m &&
              ...
              l.push(m),
              n == g || m instanceof ff
                ? n in e.sb[f] || (e.sb[f][n] = L(a.ri, a))
                : n in e.sb[f] || (e.sb[f][n] = L(Lp)));
          }
          var n = jb({}, e);
          n.node = d;
      ...
      Property: L(function (a, b, c) {
        ...
        void 0 !== b.value &&
          null !== b.value &&
          ((d = yo("http://www.opengis.net/wfs", "Value")),
          a.appendChild(d),
          b.value instanceof ff
            ? 2 === e
              ? Xp.prototype.ri(d, b.value, c)
              : Op.prototype.Yc(d, b.value, c)
            : Lp(d, b.value));
      }),
  ...
  var Ju = {
    "http://www.opengis.net/wfs": {
      Query: L(function (a, b, c) {
        ...
        if ((d = d.filter))
          (g = yo("http://www.opengis.net/ogc", "Filter")),
            a.appendChild(g),
            Oo({ node: g }, Ju, Jo(d.qc), [d], c);
      }),
    },
    "http://www.opengis.net/ogc": {
  ...
  jv.prototype.b = function (a) {
    ...
    return (a = O({ version: this.version }, kv, a, [])) ? a : null;
  };
  function lv(a, b) {
    return O({}, mv, a, b);
  }
  ...
  function pv(a, b) {
    if ((b = lv(a, b)))
      return (
        (a = [Jp(a.getAttribute("width")), Jp(a.getAttribute("height"))]),
        (b.size = a),
        b
      );
  }
  ...
  var sv = [null, "http://www.opengis.net/wms"],
    ...
    xv = M(sv, {
      ...
      BoundingBox: Ho(function (a) {
        var b = [
            Hp(a.getAttribute("minx")),
            Hp(a.getAttribute("miny")),
            Hp(a.getAttribute("maxx")),
            Hp(a.getAttribute("maxy")),
          ],
      ...
      Layer: Ho(function (a, b) {
        ...
        if (d)
          return (
            (b = Ep(a.getAttribute("queryable"))),
            void 0 === b && (b = c.queryable),
            (d.queryable = void 0 !== b ? b : !1),
            (b = Jp(a.getAttribute("cascaded"))),
            void 0 === b && (b = c.cascaded),
            (d.cascaded = b),
            (b = Ep(a.getAttribute("opaque"))),
            void 0 === b && (b = c.opaque),
            (d.opaque = void 0 !== b ? b : !1),
            (b = Ep(a.getAttribute("noSubsets"))),
            void 0 === b && (b = c.noSubsets),
            (d.noSubsets = void 0 !== b ? b : !1),
            (b = Hp(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth),
            (d.fixedWidth = b),
            (a = Hp(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight),
            (d.fixedHeight = a),
  ...
  var $v = [null, "http://www.opengis.net/wmts/1.0"],
    ...
    dw = M(
      ...
      M(aw, { SupportedCRS: K(S), Identifier: K(S) })
    ),
    kw = M(
      $v,
      {
  ...
  function vw(a) {
    return bh(a) && this.s(a)
      ? (ag(a.map.$(), 1, 1), (this.a = this.f = void 0), !0)
      : !1;
  }
  function T(a) {
    a = a ? a : {};
  ...
  function U(a) {
    ...
    void 0 !== a.loader
      ? (this.o = a.loader)
      : void 0 !== this.O && (na(this.G, 7), (this.o = Qo(this.O, this.G)));
  ...
  function zw(a, b) {
    ...
    for (c = e.length; g < c; g++)
      (h = e[g]),
        (l = w(h).toString()),
        Cw(a, l, h),
        (b = h.V()) ? ((l = b.C()), d.push(l), f.push(h)) : (a.f[l] = h);
    a.a && a.a.load(d, f);
    g = 0;
  ...
  k.ce = function () {
    ...
    else this.a && ((a = mm(this.a)), mb(this.f) || ec(a, lb(this.f)));
    return a;
  };
  k.Ph = function (a) {
    var b = [];
    ...
    void 0 !== c
      ? ((c = c.toString()),
        b in this.l
          ...
          : this.j[c] !== a && (Fw(this, a), (this.j[c] = a)))
      : b in this.l || (Fw(this, a), (this.l[b] = a));
    this.u();
  ...
  function Hw(a) {
    this.W = !this.o;
    return this.o
      ? ((this.ca = a.pixel), this.s || Rw(this, a), !0)
      : this.Sk(a)
      ? ((this.ca = a.pixel), !0)
      : !1;
  }
    ...
    this.W
      ? (this.s
          ? this.o || c
            ...
            ? this.Ld(a) && this.Od()
            : Pw(this, a)
          : (Rw(this, a), this.f === Mw && this.Od()),
        (b = !1))
      : this.o && ((this.s = null), Uw(this));
    return b;
  }
  function Qw(a, b) {
    ...
    a.s
      ? ((e = b.coordinate),
        ...
        a.f === Mw
          ? (d = a.a)
          : a.f === Lw
          ? ((d = a.a[0]), (d = d[d.length - 1]), Tw(a, b) && (e = a.s.slice()))
          : ((d = a.a), (d = d[d.length - 1])),
        (d[0] = e[0]),
        (d[1] = e[1]),
        a.ab(a.a, c),
        a.H && a.H.V().na(e),
        c instanceof D && a.f !== Lw
          ? (a.B || (a.B = new vk(new I(null))),
            (e = c.Th(0)),
            (b = a.B.V()),
            b.ba(e.ja, e.da()))
          : a.G && ((b = a.B.V()), b.na(a.G)),
        Vw(a))
      : ((b = b.coordinate.slice()),
        a.H ? a.H.V().na(b) : ((a.H = new vk(new B(b))), Vw(a)));
    return !0;
  }
  function Tw(a, b) {
    var c = !1;
  ...
  function Rw(a, b) {
    ...
    a.f === Mw
      ? (a.a = b.slice())
      : a.f === Lw
      ? ((a.a = [[b.slice(), b.slice()]]), (a.G = a.a[0]))
      : ((a.a = [b.slice(), b.slice()]), a.f === Sw && (a.G = a.a));
  ...
  function Pw(a, b) {
    ...
    if (a.f === Nw) {
      ...
      e.push(b.slice());
      a.ab(e, c);
    } else a.f === Lw && ((e = a.a[0]), e.length >= a.va && (a.o ? e.pop() : (d = !0)), e.push(b.slice()), d && (a.s = e[0]), a.ab(a.a, c));
    Vw(a);
    d && a.Od();
  }
  k.fq = function () {
  ...
  k.Od = function () {
    ...
    this.f === Nw
      ? (b.pop(), this.ab(b, c))
      : this.f === Lw && (b[0].pop(), this.ab(b, c), (b = c.U()));
    "MultiPoint" === this.O
      ? a.Ua(new Q([b]))
      : "MultiLineString" === this.O
      ? a.Ua(new P([b]))
      : "MultiPolygon" === this.O && a.Ua(new R([b]));
    ...
    (a = dx(this, c, d)) && e
      ? ((c = a[0] == e[0] || a[0] == e[2] ? a[0] : null),
        ...
        null !== c && null !== d
          ? (this.a = fx(b(a)))
          : null !== c
          ? (this.a = gx(b([c, e[1]]), b([c, e[3]])))
          : null !== d && (this.a = gx(b([e[0], d]), b([e[2], d]))))
      : ((a = d.Pa(c)), this.f([a[0], a[1], a[0], a[1]]), (this.a = fx(a)));
    return !0;
  }
  function Zw(a) {
    ...
    if (f) {
      ...
      if (Ie(b, h) <= a.B)
        return (
          ...
          (b = He(h, b)),
          (c = He(h, c)),
          (a.H = Math.sqrt(Math.min(b, c)) <= a.B),
          a.H && (g = b > c ? f[1] : f[0]),
          g
        );
    }
  ...
  Xw.prototype.f = function (a) {
    ...
    b
      ? a
        ? b.Ua(Sf(a))
        : b.Ua(void 0)
      : ((this.s = b = a ? new vk(Sf(a)) : new vk({})), this.o.ia().Gb(b));
  ...
  function ix(a) {
    ...
    a.source
      ? ((this.W = a.source),
        (a = new A(this.W.ce())),
        y(this.W, "addfeature", this.mm, this),
        y(this.W, "removefeature", this.om, this))
      : (a = a.features);
    ...
    if (c) {
      ...
      for (var g = 0, h = e.length; g < h; ++g) {
        ...
        if ("Circle" === l.geometry.T() && 1 === l.index)
          ...
          if (
            ("LineString" !== l.geometry.T() &&
              "MultiLineString" !== l.geometry.T()) ||
            !f[n][0] ||
            0 !== f[n][0].index
          )
  ...
  function lx(a) {
    ...
    a.map.$().Sh() ||
      "pointermove" != a.type ||
      this.D ||
      ((this.ya = a.pixel), ox(this, a.pixel, a.map));
    this.f &&
      this.xb(a) &&
      (b = "singleclick" == a.type && this.G ? !0 : this.yj());
  ...
  function wx(a, b) {
    var c = b.geometry;
    return "Circle" === c.T() && 1 === b.index
      ? ((a = He(c.wa(), a)), (c = Math.sqrt(a) - c.zd()), c * c)
      : Je(a, b.ma);
  }
  function vx(a, b) {
    var c = b.geometry;
      ...
      for (h in c) {
        ...
        q &&
          ...
          void 0 !== m &&
            ...
            this.a.Ca(Ba(m.ma), m)),
          xx(this, f, e, g.depth, -1),
          this.f && (this.H.ia().Lb(this.f), (this.f = null)),
          (b.length = 0));
      }
  ...
  function xx(a, b, c, d, e) {
    pm(a.a, b.C(), function (a) {
      a.geometry === b &&
        (void 0 === d || void 0 === a.depth || gc(a.depth, d)) &&
        a.index > c &&
        (a.index += e);
    });
  }
          ...
          if (this.l(a, e))
            return (
              (!b && !d) || cc(g.a, a)
                ? (c || d) &&
                  cc(g.a, a) &&
                  (h.push(a), (e = w(a)), delete this.a[e])
  ...
  k.Ki = function (a) {
    if (a instanceof Dw) var b = a.feature;
  ...
  k.setMap = function (a) {
    ...
    a &&
      (this.j
        ? c.push(
            y(this.j, "add", this.Ki, this),
            y(this.j, "remove", this.Li, this)
          )
        : this.s &&
          c.push(
            y(this.s, "addfeature", this.Ki, this),
            y(this.s, "removefeature", this.Li, this)
          ),
  ...
  function Nx(a, b, c) {
    return c.Sc(
      ...
      { layerFilter: a.B, hitTolerance: a.s }
    );
  }
    ...
    this.l(
      function (a) {
        ...
        var b = (255 * a) | 0,
          c = this.o[b];
        c ||
          ((c = [new pk({ image: new hr({ opacity: a, src: this.G }) })]),
          (this.o[b] = c));
        return c;
      }.bind(this)
    );
  ...
  function dy(a, b, c, d, e, f, g, h, l, m, n) {
    ...
    if (0 === Za(f)) this.state = 4;
      ...
      ((h = a.C()) && (e ? (e = eb(e, h)) : (e = h)),
      (d = fn(a, c, cb(f), d.Sa(this.v[0]))),
      !isFinite(d) || 0 >= d)
    )
      this.state = 4;
    else if (
      ((this.o = new jn(a, c, f, e, d * (void 0 !== m ? m : 0.5))),
      0 === this.o.c.length)
    )
      this.state = 4;
    else if (
      ...
      e &&
        (a.g
          ? ((c[1] = oa(c[1], e[1], e[3])), (c[3] = oa(c[3], e[1], e[3])))
          : (c = eb(c, e))),
      Za(c))
    ) {
      a = tc(b, c, this.f);
  ...
  dy.prototype.fe = function () {
    ...
    this.a.forEach(function (b) {
      b &&
        2 == b.getState() &&
        a.push({ extent: this.c.La(b.xa), image: b.Y() });
    }, this);
    this.a.length = 0;
          ...
          var d = y(
            ...
            function () {
              ...
              if (2 == c || 3 == c || 4 == c)
                Gc(d),
                  a--,
                  0 === a && (this.Hd.forEach(Gc), (this.Hd = null), this.fe());
            },
            this
          );
          this.Hd.push(d);
  ...
  k.bb = function (a) {
    var b = this.c;
    return !this.tileGrid || (b && !Wb(b, a))
      ? ((b = w(a).toString()), b in this.s || (this.s[b] = zc(a)), this.s[b])
      : this.tileGrid;
  };
  k.Xd = function (a) {
    var b = this.c;
  ...
  k.$d = function (a, b, c) {
    this.source.$d(a, b, c);
    b !== this.resolution &&
      (this.clear(), (this.resolution = b), sy(this), this.Oc(this.features));
  };
  k.lq = function (a) {
    this.distance = a;
    this.ra();
  ...
  function wy(a) {
    qn.call(this, { projection: a.projection, resolutions: a.resolutions });
    this.W = void 0 !== a.crossOrigin ? a.crossOrigin : null;
  ...
  k.Vc = function (a, b, c, d) {
    ...
    a = db(f, e, 0, [
      Math.ceil((this.O * ab(a)) / e),
      Math.ceil((this.O * bb(a)) / e),
    ]);
    if (
      (f = this.N) &&
      this.W == this.g &&
  ...
  (function (a) {
    ...
    function f(a) {
      ...
      var c = [];
      if (b) for (var f = 0; f < b; ++f) c[f] = d(a, this.wh.bind(this, f));
      else c[0] = e(a, this.wh.bind(this, 0));
      this.ve = c;
      this.Md = [];
    ...
    f.prototype.Ip = function (a, b, c) {
      this.uk({ inputs: a, fi: b, callback: c });
      this.th();
    };
      ...
      if (0 === this.ue && 0 < this.Md.length) {
        ...
        if (1 === e)
          this.ve[0].postMessage(
            { buffers: d, meta: a.fi, imageOps: this.Hf, width: b, height: c },
            d
          );
        else
          for (
    ...
    if (!b && c) {
      ...
      if (e === this.l.viewState.resolution && Ra(b, this.l.extent)) {
        if (this.a) var f = this.a.Y().getContext("2d");
          ...
          (f = gg(Math.round(ab(b) / e), Math.round(bb(b) / e))),
  ...
  function Ey(a) {
    for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
      var e = d,
        ...
        g = null;
      f instanceof ey
        ? ((f = new Vx({ source: f })), (g = new bj(f)))
        : f instanceof qn && ((f = new Ux({ source: f })), (g = new Si(f)));
      c[e] = g;
    }
    return c;
  }
    ...
    if (!(d.b.length <= a[0])) {
      ...
      g
        ? ((c = c.ub.split(":").pop()),
          ...
          (a = (1 == g.length ? g[0] : g[va((a[1] << a[0]) + a[2], g.length)])
            .replace(/MapServer\/?$/, "MapServer/export")
            .replace(/ImageServer\/?$/, "ImageServer/exportImage")),
          (a = uy(a, d)))
        : (a = void 0);
  ...
  function Ty(a) {
    ey.call(this, { projection: Nb("EPSG:3857"), state: "loading" });
  ...
  k.Wk = function (a, b, c, d, e) {
    this.tileGrid
      ? ((b = this.tileGrid.Ke(a, b)),
        Uy(this.$c(b[0], b[1], b[2], 1, this.c), a, c, d, e))
      : !0 === e
      ? setTimeout(function () {
          c.call(d, null);
        }, 0)
  ...
  k.Yo = function (a, b, c, d) {
    ...
    if (!(f.b.length <= b[0])) {
      ...
      e &&
        e !== c &&
        ((g = fn(e, c, a, g)), (h = $b(h, c, e)), (a = Zb(a, c, e)));
      l = {
        SERVICE: "WMS",
        VERSION: "1.3.0",
        REQUEST: "GetFeatureInfo",
  ...
  function $y(a, b, c, d, e, f, g) {
    ...
    if (h) {
      ...
      g.BBOX = d.join(",");
      return uy(
        1 == h.length ? h[0] : h[va((b[1] << b[0]) + b[2], h.length)],
        g
      );
    }
  }
  ...
  function ak(a, b) {
    b = w(b).toString();
    b in a.o || (a.o[b] = { Ae: !1, dh: null, uf: -1, eh: -1 });
    return a.o[b];
  }
  k.ib = function () {
  ...
  k.Hh = function () {
    ...
    a == this.a.length
      ? (this.f.forEach(Gc), (this.f.length = 0), dj(this, 2))
      : dj(this, b == this.a.length ? 4 : 3);
  };
  function bz(a, b) {
  ...
  function Z(a) {
    function b(a) {
      ...
      return function (b) {
        if (b) {
          var c = { TileMatrix: e.s[b[0]], TileCol: b[1], TileRow: -b[2] - 1 };
          jb(c, g);
          b = a;
          return (b =
            "KVP" == d
  ...
  function gz(a) {
    ...
    d.reverse();
    var l = new qc({ tileSize: f, extent: b, origin: Ya(b), resolutions: d });
    (b = a.url) &&
  ...
  t("ol.loadingstrategy.tile", function (a) {
    return function (b, c) {
      ...
      for (c[1] = b.fa; c[1] <= b.la; ++c[1])
        for (c[2] = b.ea; c[2] <= b.ka; ++c[2]) d.push(a.La(c));
      return d;
    };
  });
  t("ol.Map", J);
